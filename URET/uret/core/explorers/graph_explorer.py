...
class GraphExplorer(ABC):
    ...
    #     sample = x[0][i], x[1][i], x[2][i], x[3][i], x[4], x[5][i], x[6][i]
        ...
        print(generated_samples[0].shape, file=terminal_output)
        print(generated_samples[1].shape, file=terminal_output)
        print(generated_samples[2].shape, file=terminal_output)
        print(generated_samples[3].shape, file=terminal_output)
        print(generated_samples[4].shape, file=terminal_output)
        print(generated_samples[5].shape, file=terminal_output)
        print(generated_samples[6].shape, file=terminal_output)
